...
Small Android apps built with Jetpack Compose and the MVVM pattern, using StateFlow for reactive state management. Includes UI tests.
...
Kotlin · Jetpack Compose · ViewModel · StateFlow · Material 3 · Coroutines
